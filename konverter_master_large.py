...
OUTPUT_DIR = "universum_master_large"
...
<body class="light-mode">
    ...
    style_css = """
:root { --bg-color: #090a0f; --paper-color: #fdfaf3; --text-color: #2c3e50; --accent-color: #b8860b; }
body.dark-mode { --bg-color: #050505; --paper-color: #1a1a1a; --text-color: #e0e0e0; }
...
#wrapper { flex: 1; display: flex; align-items: center; justify-content: center; width: 100%; padding: 20px; box-sizing: border-box; }

.stars { position: fixed; top:0; left:0; width:100%; height:100%; background: url('https://www.transparenttextures.com/patterns/stardust.png'); opacity: 0.3; pointer-events: none; }
...
img { max-width: 100%; max-height: 450px; display: block; margin: 30px auto; border-radius: 5px; border: 5px solid #fff; box-shadow: 0 5px 15px rgba(0,0,0,0.3); }

.controls { margin-bottom: 20px; z-index: 100; display: flex; align-items: center; background: rgba(0,0,0,0.7); padding: 12px 25px; border-radius: 50px; backdrop-filter: blur(10px); }
...
button { padding: 10px 18px; cursor: pointer; background: var(--accent-color); color: white; border: none; border-radius: 20px; font-weight: bold; margin: 0 5px; transition: 0.3s; }
"""
